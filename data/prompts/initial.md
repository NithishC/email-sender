...
3. **Proof Line - Quantified Achievement** (1 sentence):
   ...
   - Examples:
     - "Recently cut AI pipeline runtime by 60% (12h to 4h) using ECS Fargate at CharacterQuilt."
...
Recently shipped end-to-end agentic system in one week at CharacterQuilt, orchestrating Claude, GPT-5, O3 with retries, circuit breakers, and stateful execution.
...
Cut AI pipeline runtime by 60% (12h to 4h) using ECS Fargate and shipped multi-LLM orchestration at CharacterQuilt.
