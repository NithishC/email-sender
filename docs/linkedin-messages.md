...
Saw your work at Liberty Mutual. I scaled AI pipelines from 14h to 4h using ECS Fargate + SQS + Lambda at YourCompany. Would love to connect and share notes on serverless infrastructure at scale.
```
...
Really impressed by Liberty Mutual's serverless-first approach and the work you're doing modernizing legacy systems at scale. I've dealt with similar challenges orchestrating multi-LLM systems with 200+ parallel executors at YourCompany.
